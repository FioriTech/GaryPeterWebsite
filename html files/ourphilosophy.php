            ...
            <div class="container clearfix">
                <main id="main" class="site-main clearfix">
                    ...
                    <div class="entry-content">
                        ...
                        <p>“<em>How wonderful is that nobody needs a single moment before starting to improve the world</em>.”<br />
                            – <em> Anne Frank </em></p>
                        <p>“<em>Thousands of candles can be lighted from a single candle, and the life of the candle will not be shortened. Happiness never decreases by being shared</em>.”<br />
                            – <em> Gautam Buddha </em></p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <h6>Humanitarian Work by Gary Peter Group</h6>
                        <p>We are associated with charitable organizations from various countries. We lend our support to these organizations in following ways:</p>
                        <ul>
                            <li>Volunteer our time</li>
                            <li>Raise funds on their behalf</li>
                            <li>Make donations to their cause</li>
                        </ul>
                        <h6>Major causes supported by Gary Peter Group</h6>
                        <ul>
                            <li>Supporting disabled children</li>
                            <li>Supporting disadvantaged children and adults</li>
                        </ul>
                ...
                <ul class="default-wp-page clearfix">
                    <li class="next"> <a href="A1Ctest.php" rel="prev"><span class="meta-nav"></span> Free A1C Now test: World Diabetic Day&rarr;</a> </li>
                    <li class="previous"> <a href="realestate.php" rel="next">&larr;Real Estate Fund <span class="meta-nav"></span></a> </li>
                </ul>
